...
import { Wifi, Baby, Accessibility, Wine, Music, Car } from 'lucide-react';
    ...
    <section id="chi-siamo" className="py-20 md:py-32 bg-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[minmax(180px,auto)]">
          ...
          {/* Card 1: Ospitalità (Blue Card) */}
          <div className="group md:col-span-1 lg:col-span-2 bg-brand-blue rounded-[2rem] p-8 text-white flex flex-col justify-between shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 relative overflow-hidden min-h-[280px]">
          ...
          {/* Card 2: Famiglia (Cream Card) */}
          <div className="group md:col-span-1 bg-[#FFF8F0] border border-brand-gold/10 rounded-[2rem] p-8 flex flex-col justify-center shadow-sm hover:shadow-lg transition-all duration-300 min-h-[280px]">
           ...
           {/* Card 3: Accessibilità (White Card) */}
           <div className="group md:col-span-1 bg-white border border-slate-100 rounded-[2rem] p-8 flex flex-col justify-center shadow-sm hover:shadow-lg transition-all duration-300 min-h-[280px]">
          ...
          {/* Card 4: Servizi Extra (Wide Bottom Card) */}
